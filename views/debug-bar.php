...
<div id="glbb-debug-bar">
	...
	<a href="javascript:Blackbar.switchPanel('glbb-actions')" class="glbb-actions"><?= $actionsLabel; ?></a>
	<div id="glbb-actions" class="glbb-debug-panel">
		<?php $blackbar->render('panels/actions', array('actions' => $actions)); ?>
	</div>
